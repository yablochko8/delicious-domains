...
const AboutContents = () => {
    return (
        <div className="flex flex-col gap-4 text-sm text-justify">
            ...
            <div>
                It includes lots of the "dot-something" domains (e.g. .art, .book, .cat). Conventional wisdom says these are a terrible idea. Paul Graham advocates to stick to dotcom domains (<a href="http://aux.messymatters.com/pgnames.html" target="_blank" rel="noopener noreferrer" >2006</a>, <a href="https://paulgraham.com/name.html" target="_blank" rel="noopener noreferrer" >2015</a>).
            </div>

            <div>
                That said, there are now over 1,000 top-level domains, and you probably haven't heard of most of them. If you just need a quick, cheap, descriptive domain they open up a ton of options.
            </div>

            <div>
                Every domain shown should come in under $100, with the exception of .ai domains which have a sneaky two-year minimum. {WEBSITE_NAME} excludes all premium / resale / auction domains from results.
            </div>
